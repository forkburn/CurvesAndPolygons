...
import com.warfactory.curvesandpolygons.services.ScrWallpaperService;
...
implements OnPreferenceClickListener, OnPreferenceChangeListener{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		getPreferenceManager().setSharedPreferencesName(ScrWallpaperService.SHARED_PREFS_NAME);
